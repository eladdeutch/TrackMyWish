...
import com.andro.obe.trackmywish.Utilities.Constants;
import com.andro.obe.trackmywish.Utilities.GeofenceErrorMessages;
import com.andro.obe.trackmywish.Utilities.GeofenceTransitionsIntentService;
...
public class ItemActivity extends AppCompatActivity implements
    ...
    public void populateGeofenceList() {
        mGeofenceList.add(new Geofence.Builder()
                ...
                .setCircularRegion(
                        currentItem.getmPlace().getLatitude(),
                        currentItem.getmPlace().getLongitude(),
